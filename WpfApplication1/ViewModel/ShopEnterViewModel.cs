...
namespace WpfApplication1.ViewModel
{
    ...
    public class ShopEnterViewModel
    {
        ...
        {
            SnowRentLibrary.Shop.Product product = new Cold();
            product.Id = 1;
            product.Name = "Glace";
        ...
        private SnowRentLibrary.Shop.Client SetupClient()
        {
            SnowRentLibrary.Shop.Client client = new SnowRentLibrary.Shop.Client();
            client.Id = 1;
            client.Name = "Jhon";
        ...
        private SnowRentLibrary.Shop.Client SetupClient1()
        {
            SnowRentLibrary.Shop.Client client = new SnowRentLibrary.Shop.Client();
            client.Id = 3;
